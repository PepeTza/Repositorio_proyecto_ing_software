let boton = document.getElementById("btnPersonal")
...
let registrarPersonal = async()=>{
    ...
    try {
        ...
        if(!valid){
            ...
            // Aquí se registrará el personal
            const peticion = await fetch('http://localhost:8085/api/personal/save', {
                method: "POST",
                headers: {
        ...
        console.error("Error al registrar al empleado común:", error);
...
function mostrarMensajeExito() {
    ...
    messageTitle.textContent = 'Empleado común registrado con éxito';
